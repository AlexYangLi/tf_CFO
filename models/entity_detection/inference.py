...
from gen_seqlabeling_data import read_data_for_inference
...
def gen_test_result(model_type, model_path, test_data):
    q_lineid, q_word_ids, q_seq_len, q_char_ids, q_word_len, q_labels = test_data
    ...
    with tf.Session() as sess:
        ...
        question_char_ids = graph.get_tensor_by_name('question_char_ids:0')
        ...
        feed_dict = {question_word_ids: q_word_ids, sequence_len:q_seq_len,
                     question_char_ids: q_char_ids, word_len:q_word_len, 
        ...
        save_path = model_name + '_test_result.csv'
...
if __name__ == '__main__':
    ...
    char2idx = pickle_load('../../data/fb_char2idx.pkl')
    test_data = read_data_for_inference('../../data/test.csv', word2idx, char2idx)
