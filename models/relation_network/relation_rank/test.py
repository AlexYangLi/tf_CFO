...
def compute_accuracy(model_path, data):
    ...
    q_word_ids, q_seq_len, q_pos_rel_ids, cand_rel_ids = data
    ...
    for i in range(len(q_word_ids)):
        ...
        # print(mul_q_word_ids_npy.shape, mul_q_seq_len.shape, len(cand_rel_ids[i]))
        feed_dict = {question_ids: mul_q_word_ids_npy,
                     sequence_len: mul_q_seq_len,
                     pos_rel_ids: cand_rel_ids[i],
                     gru_keep_prob: 1.0
                     }
...
if __name__ == '__main__':
    ...
    idx2relation = pickle_load('../../../data/FB5M_idx2relation.pkl')
    subject2rel = pickle_load('../../../data/FB5M_subject2rel.pkl')
    _, test_data_metric = read_data(sys.argv[2], subject2rel, word2idx, relation2idx)
